...
matriz_cov <- cov(df_num, use = "complete.obs")
matriz_corr_Pearson <- cor(df_num,method = c("pearson"), use = "complete.obs")
matriz_corr_Spearman <- cor(df_num,method = c("spearman"), use = "complete.obs")
...
df_num_2 <- df_num %>% mutate(ALG.num_0.5 = (ALG.num)**0.5) %>% select(-ALG.num)

matriz_cov_2 <- cov(df_num_2, use = "complete.obs")
matriz_corr_Pearson_2 <- cor(df_num_2,method = c("pearson"), use = "complete.obs")
matriz_corr_Spearman_2 <- cor(df_num_2,method = c("spearman"), use = "complete.obs")
